...
if [ $workload == 'w3' ]
then
    plot_label=(Basic HomaP1O4 HomaP2O4 HomaP4O4 HomaP8O4)
    protocol=(basic homa homa homa homa)
    driver=(dpdk dpdk dpdk dpdk dpdk)
    params=(""
            "rttMicros=8,unschedPrio=4,degreeOC=4,dpdkPrio=1,unschedPrioCutoffs=469.5521.15267"
            "rttMicros=8,unschedPrio=4,degreeOC=4,dpdkPrio=2,unschedPrioCutoffs=469.5521.15267"
            "rttMicros=8,unschedPrio=4,degreeOC=4,dpdkPrio=4,unschedPrioCutoffs=469.5521.15267"
            "rttMicros=8,unschedPrio=4,degreeOC=4,dpdkPrio=8,unschedPrioCutoffs=469.5521.15267")
elif [ $workload == 'w4' ] || [ $workload == 'w5' ]
then
    plot_label=(Basic HomaP1O7 HomaP1O3 HomaP2O7 HomaP2O3 HomaP4O7 HomaP4O3 HomaP8O7 HomaP8O3)
    protocol=(basic homa homa homa homa homa homa homa homa)
